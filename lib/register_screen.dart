...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_screenWidth >= 650 && _screenWidth < 1000) {
      _formPadding = EdgeInsets.only(left: 75, right: 75);
    } else if (_screenWidth >= 1000 && _screenWidth < 1920) {
      _formPadding = EdgeInsets.only(left: 175, right: 175);
